...
class MetaTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Squelette.Map.MetaTableMap';
     ...
     */
    const OM_CLASS = '\\Squelette\\Meta';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Squelette.Meta';
     ...
     */
    const COL_TITLE = 'meta.title';

    /**
     * the column name for the description field
     */
    const COL_DESCRIPTION = 'meta.description';

    /**
     * the column name for the keywords field
     */
    const COL_KEYWORDS = 'meta.keywords';

    /**
     * the column name for the custom field
     */
    const COL_CUSTOM = 'meta.custom';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Title', 'Description', 'Keywords', 'Custom', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'title', 'description', 'keywords', 'custom', ),
        self::TYPE_COLNAME       => array(MetaTableMap::COL_ID, MetaTableMap::COL_NAME, MetaTableMap::COL_TITLE, MetaTableMap::COL_DESCRIPTION, MetaTableMap::COL_KEYWORDS, MetaTableMap::COL_CUSTOM, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'title', 'description', 'keywords', 'custom', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Title' => 2, 'Description' => 3, 'Keywords' => 4, 'Custom' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'title' => 2, 'description' => 3, 'keywords' => 4, 'custom' => 5, ),
        self::TYPE_COLNAME       => array(MetaTableMap::COL_ID => 0, MetaTableMap::COL_NAME => 1, MetaTableMap::COL_TITLE => 2, MetaTableMap::COL_DESCRIPTION => 3, MetaTableMap::COL_KEYWORDS => 4, MetaTableMap::COL_CUSTOM => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'title' => 2, 'description' => 3, 'keywords' => 4, 'custom' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Squelette\\Meta');
        ...
        $this->addColumn('keywords', 'Keywords', 'VARCHAR', false, 1024, null);
        $this->addColumn('custom', 'Custom', 'LONGVARCHAR', false, null, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MetaTableMap::COL_NAME);
            $criteria->addSelectColumn(MetaTableMap::COL_TITLE);
            $criteria->addSelectColumn(MetaTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(MetaTableMap::COL_KEYWORDS);
            $criteria->addSelectColumn(MetaTableMap::COL_CUSTOM);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Squelette\Meta) { // it's a model object
