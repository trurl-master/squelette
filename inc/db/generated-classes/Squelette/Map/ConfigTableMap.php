...
use Squelette\Config;
use Squelette\ConfigQuery;
...
class ConfigTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Squelette.Map.ConfigTableMap';
     ...
     */
    const OM_CLASS = '\\Squelette\\Config';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Squelette.Config';
     ...
     */
    const COL_TYPE = 'config.type';

    /**
     * the column name for the label field
     */
    const COL_LABEL = 'config.label';

    /**
     * the column name for the note field
     */
    const COL_NOTE = 'config.note';

    /**
     * the column name for the group field
     */
    const COL_GROUP = 'config.group';

    /**
     * the column name for the params field
     */
    const COL_PARAMS = 'config.params';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Key', 'Value', 'Type', 'Label', 'Note', 'Group', 'Params', ),
        self::TYPE_CAMELNAME     => array('key', 'value', 'type', 'label', 'note', 'group', 'params', ),
        self::TYPE_COLNAME       => array(ConfigTableMap::COL_KEY, ConfigTableMap::COL_VALUE, ConfigTableMap::COL_TYPE, ConfigTableMap::COL_LABEL, ConfigTableMap::COL_NOTE, ConfigTableMap::COL_GROUP, ConfigTableMap::COL_PARAMS, ),
        self::TYPE_FIELDNAME     => array('key', 'value', 'type', 'label', 'note', 'group', 'params', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Key' => 0, 'Value' => 1, 'Type' => 2, 'Label' => 3, 'Note' => 4, 'Group' => 5, 'Params' => 6, ),
        self::TYPE_CAMELNAME     => array('key' => 0, 'value' => 1, 'type' => 2, 'label' => 3, 'note' => 4, 'group' => 5, 'params' => 6, ),
        self::TYPE_COLNAME       => array(ConfigTableMap::COL_KEY => 0, ConfigTableMap::COL_VALUE => 1, ConfigTableMap::COL_TYPE => 2, ConfigTableMap::COL_LABEL => 3, ConfigTableMap::COL_NOTE => 4, ConfigTableMap::COL_GROUP => 5, ConfigTableMap::COL_PARAMS => 6, ),
        self::TYPE_FIELDNAME     => array('key' => 0, 'value' => 1, 'type' => 2, 'label' => 3, 'note' => 4, 'group' => 5, 'params' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Squelette\\Config');
        ...
        $this->addColumn('label', 'Label', 'VARCHAR', false, 64, null);
        $this->addColumn('note', 'Note', 'VARCHAR', false, 64, null);
        $this->addColumn('group', 'Group', 'VARCHAR', false, 32, null);
        $this->addColumn('params', 'Params', 'VARCHAR', false, 1024, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ConfigTableMap::COL_LABEL);
            $criteria->addSelectColumn(ConfigTableMap::COL_NOTE);
            $criteria->addSelectColumn(ConfigTableMap::COL_GROUP);
            $criteria->addSelectColumn(ConfigTableMap::COL_PARAMS);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Squelette\Config) { // it's a model object
