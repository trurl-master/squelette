...
abstract class Config implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Squelette\\Map\\ConfigTableMap';
    ...
    /**
     * Initializes internal state of Squelette\Base\Config object.
     */
     ...
     * @return $this|\Squelette\Config The current object (for fluent API support)
     */
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[ConfigTableMap::COL_LABEL] = true;
        }
    ...
    public function setNote($v)
    {
        ...
        if ($this->note !== $v) {
            $this->note = $v;
            $this->modifiedColumns[ConfigTableMap::COL_NOTE] = true;
        }
    ...
    public function setGroup($v)
    {
        ...
        if ($this->group !== $v) {
            $this->group = $v;
            $this->modifiedColumns[ConfigTableMap::COL_GROUP] = true;
        }
    ...
    public function setParams($v)
    {
        ...
        if ($this->params !== $v) {
            $this->params = $v;
            $this->modifiedColumns[ConfigTableMap::COL_PARAMS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ConfigTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ConfigTableMap::translateFieldName('Label', TableMap::TYPE_PHPNAME, $indexType)];
            $this->label = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ConfigTableMap::translateFieldName('Note', TableMap::TYPE_PHPNAME, $indexType)];
            $this->note = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ConfigTableMap::translateFieldName('Group', TableMap::TYPE_PHPNAME, $indexType)];
            $this->group = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ConfigTableMap::translateFieldName('Params', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Squelette\\Config'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ConfigTableMap::COL_LABEL)) {
            $modifiedColumns[':p' . $index++]  = 'label';
        }
        if ($this->isColumnModified(ConfigTableMap::COL_NOTE)) {
            $modifiedColumns[':p' . $index++]  = 'note';
        }
        if ($this->isColumnModified(ConfigTableMap::COL_GROUP)) {
            $modifiedColumns[':p' . $index++]  = 'group';
        }
        if ($this->isColumnModified(ConfigTableMap::COL_PARAMS)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Squelette\Config The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ConfigTableMap::COL_LABEL)) {
            $criteria->add(ConfigTableMap::COL_LABEL, $this->label);
        }
        if ($this->isColumnModified(ConfigTableMap::COL_NOTE)) {
            $criteria->add(ConfigTableMap::COL_NOTE, $this->note);
        }
        if ($this->isColumnModified(ConfigTableMap::COL_GROUP)) {
            $criteria->add(ConfigTableMap::COL_GROUP, $this->group);
        }
        if ($this->isColumnModified(ConfigTableMap::COL_PARAMS)) {
            $criteria->add(ConfigTableMap::COL_PARAMS, $this->params);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Squelette\Config (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Squelette\Config Clone of current object.
     * @throws PropelException
     */
